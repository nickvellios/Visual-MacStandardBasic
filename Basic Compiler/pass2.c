...
*/                    case 'w':  // small c   This is for form id
                    ...
                    case 'R':    // User defined Sub
                        ...
                        break;
                    case 'T':    // THEN
                        if (line[line_pos] == 'T' && line[line_pos + 1] == 'H' && line[line_pos + 2] == 'E' &&
                            line[line_pos + 3] == 'N') {
                            line_pos += 4;
                    ...
                    case 's':    // STEP (Optional)
                        if (line[line_pos] == 'S' && line[line_pos + 1] == 'T' && line[line_pos + 2] == 'E' &&
                            line[line_pos + 3] == 'P') {
                            line_pos += 4;
                            while (line[line_pos] == ' ' && line_pos <= line[0]) line_pos++;
                            c = compile_argument('L');
