        ...
        switch (cmdstr[0]) {
            case 'S':
                if (!strcmp(cmdstr, "START")) {
                    ...
                    return (kLineStart + ret);
                }
                if (!strcmp(cmdstr, "SUB")) {
                    ProcLineCtr = line_ctr;
                    strcpy((char *) CurrProc, (char *) line + 1);
                    return (kLineSub + ret);
                }
                break;
            case 'E':
                if (!strcmp(cmdstr, "ENDSUB")) {
                    ProcLineCtr = line_ctr;
                    strcpy((char *) CurrProc, (char *) line + 1);
                    return (12 + ret);
                }
                if (!strcmp(cmdstr, "ENDGLOBAL")) {
                    ProcLineCtr = line_ctr;
                    strcpy((char *) CurrProc, (char *) line + 1);
                    return (14 + ret);
                }
                if (!strcmp(cmdstr, "ENDFUNCTION")) {
                    ProcLineCtr = line_ctr;
                    strcpy((char *) CurrProc, (char *) line + 1);
                    return (16 + ret);
                }
            ...
            case 'D':
                ...
                break;
            case 'G':
                if (!strcmp(cmdstr, "GLOBAL")) {
                    ProcLineCtr = line_ctr;
                    strcpy((char *) CurrProc, (char *) line + 1);
                    return (kCompInGlobal + ret);
                }
                break;
            case 'F':
                if (!strcmp(cmdstr, "FUNCTION")) {
                    ProcLineCtr = line_ctr;
                    strcpy((char *) CurrProc, (char *) line + 1);
                    return (15 + ret);
                }
                    ...
                    if (!GlobalData.CompMode) {
                        ...
                        if (!GlobalData.DimMode) {
                            ...
                            */
                            ...
                            looper = 0;
                            while (!looper) {
                                if (line[line_pos] == 'D' && line[line_pos + 1] == 'I' && line[line_pos + 2] == 'M' &&
                                    line[line_pos + 3] == ' ') {
                                    line_pos += 4;
                                    process_dims(0);
