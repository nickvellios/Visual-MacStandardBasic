...
extern unsigned char line[260], RawLine[260];
char *zbuffer;
char zline[260];
...
/*void zsplitold2()
{
	...
	zparm1[0]=b-1;  zparm2[0]=c-1;
	zparm1[b]=0;  	zparm2[c]=0;
}*/
void zsplit2() {
    short a, b = 1, c = 1;
    a = 0;
    while (RawLine[a] && b < 256) {
        if (RawLine[a] == '=') break;
        else zparm1[b++] = RawLine[a++];
    }
    if (RawLine[a] == '=') a++;
    while (RawLine[a] && c < 256) {
        zparm2[c++] = RawLine[a++];
    }
    zparm1[0] = b - 1;
    zparm2[0] = c - 1;
