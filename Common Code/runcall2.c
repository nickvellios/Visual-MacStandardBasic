...
short cmd_picturebegin()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in PictureBegin command"); return 0 ; } 
	}
	...
	if( openPictureFlag ) { ErrHandler( 1044, nil); return(0); }
...
short cmd_picturedone()		
{
	if( !openPictureFlag )	{ ErrHandler( 1043, nil); return(0); }
...
short cmd_picturesave()
{
	...
	if( openPictureHandle == nil ) { ErrHandler( 1045, nil); return(0); }
...
short cmd_drawtext()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in DrawText command"); return 0 ; } 
	}
...
short cmd_drawfont()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in DrawFont command"); return 0 ; } 
	}
...
short cmd_drawsize()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in DrawSize command"); return 0 ; } 
	}
...
short cmd_drawstyle()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in DrawStyle command"); return 0 ; } 
	}
...
short cmd_moveto()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in MoveTo command"); return 0 ; } 
	}
...
short cmd_lineto()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in LineTo command"); return 0 ; } 
	}
...
short cmd_point()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in Point command"); return 0 ; } 
	}
...
short cmd_line()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in Line command"); return 0 ; } 
	}
...
short cmd_box()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in Box command"); return 0 ; } 
	}
...
short cmd_boxfill()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in BoxFill command"); return 0 ; } 
	}
...
short cmd_circle()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in Circle command"); return 0 ; } 
	}
...
short cmd_circlefill()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in CircleFill command"); return 0 ; } 
	}
...
short cmd_ellipse()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in Ellipse command"); return 0 ; } 
	}
...
short cmd_ellipsefill()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in EllipseFill command"); return 0 ; } 
	}
...
short cmd_drawpicture()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in DrawPicture command"); return 0 ; } 
	}
...
short cmd_setcolor()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in SetColor command"); return 0 ; } 
	}
...
short cmd_backcolor()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in BackColor command"); return 0 ; } 
	}
...
short cmd_backRGBcolor()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in BackColorRGB command"); return 0 ; } 
	}
...
short cmd_setRGBcolor()
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in SetColorRGB command"); return 0 ; } 
	}
...
short cmd_pensize()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in PenSize command"); return 0 ; } 
	}
...
short cmd_penpattern()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in PenPattern command"); return 0 ; } 
	}
...
short cmd_penmode()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in PenMode command"); return 0 ; } 
	}
...
short cmd_pennormal()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v = FindFormID( d );
		if( v == -1 ) {ErrHandler( 1009, "\p in PenNormal command"); return 0 ; } 
	}
	else
	{
		switch(CodeBuf[CodePos++])
...
short cmd_stretchline()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in StretchLine command"); return 0 ; } 
	}
...
short cmd_stretchbox()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in StretchBox command"); return 0 ; } 
	}
...
short cmd_stretchoval()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in StretchEllipse command"); return 0 ; } 
	}
	for(a=b; a<3; a++)
	{
		switch(CodeBuf[CodePos++])
...
short cmd_stretchcircle()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v[0] = FindFormID( d );
		if( v[0] == -1 ) {ErrHandler( 1009, "\p in StretchCircle command"); return 0 ; } 
	}
	for(a=b; a<3; a++)
	{
		switch(CodeBuf[CodePos++])
...
short cmd_spriteframe()		
{
	...
	if( c==2 )
	{
		...
		CodePos+=2;
		v = FindFormID( d );
		if( v == -1 ) {ErrHandler( 1009, "\p in SpriteFrame command"); return 0 ; } 
	}
	else
	{
		switch(CodeBuf[CodePos++])
