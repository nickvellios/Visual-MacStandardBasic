        ...
        switch (ITemp) {
            ...
            case 4:
                ...
                for (a = 0; a < 3; a++) {
                    if (CodeBuf[CodePos] == 251) {
                        CodePos++;
                        dv[a] = (short double) get_longarg_val();
                    } else if (CodeBuf[CodePos] == 250) {
                        CodePos++;
                        dv[a] = get_doublearg_val();
                    }
                }
                // Check direction & set up LoopStack
                VR_Double = dv[0];
...
short cmd_closewindow() {
    ...
    if (c == 2) {
        ...
        v = FindFormID(d);
        if (v == -1) {
            ErrHandler(1009, "\p in WinClose command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_redrawwindow() {
    ...
    a = GFX_WinRedraw(v);
    if (a < 0) {
        ErrHandler(1009, "\pin WinRedraw command");
        return (99);
    }
    return (0);
}
...
short cmd_hidewindow() {
    ...
    a = GFX_HideWindow(v);
    if (a < 0) {
        ErrHandler(1009, "\pin WinHide command");
        return (99);
    }
    return (0);
}
...
short cmd_cleargraphics() {
    ...
    if (c == 2) {
        ...
        v = FindFormID(d);
        if (v == -1) {
            ErrHandler(1009, "\p in ClearGraphics command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_clearcontrols() {
    ...
    if (c == 2) {
        ...
        v = FindFormID(d);
        if (v == -1) {
            ErrHandler(1009, "\p in ClearControls command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_clearwindow() {
    ...
    if (c == 2) {
        ...
        v = FindFormID(d);
        if (v == -1) {
            ErrHandler(1009, "\p in ClearWindow command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_drawupdate() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1009, "\p in DrawUpdate command");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
...
short cmd_showwindow() {
    ...
    a = GFX_ShowWindow(v);
    if (a < 0) {
        ErrHandler(1009, "\pin WinShow command");
        return (99);
    }
    return (0);
}
...
short cmd_movewindow() {
    ...
    if (a < 0) {
        ErrHandler(1009, "\pin WinMove command");
        return (99);
    }
    return (0);
}
...
short cmd_winorigin() {
    ...
    if (a < 0) {
        ErrHandler(1009, "\pin WinOrigin command");
        return (99);
    }
    return (0);
}
...
short cmd_sizewindow() {
    ...
    if (a < 0) {
        ErrHandler(1009, "\pin WinSize command");
        return (99);
    }
    return (0);
}
...
short cmd_clipwindow() {
    ...
    if (a < 0) {
        ErrHandler(1009, "\pin WinClip command");
        return (99);
    }
    return (0);
}
...
short cmd_loadpal() {
    ...
    if (a < 0) {
        ErrHandler(1009, "\pin LoadPalette command");
        return (99);
    }
    return (0);
}
...
short cmd_winpal() {
    ...
    if (a < 0) {
        ErrHandler(1009, "\pin WinPalette command");
        return (99);
    }
    return (0);
}
...
short cmd_windowtitle() {
    ...
    if (a < 0) {
        ErrHandler(1009, "\pin WinTitle command");
        return (99);
    }
    return (0);
}
...
short cmd_droplist() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1009, "\p in DropList command");
            return 0;
        }
    }
    for (a = b; a < 4; a++) {
...
short cmd_button() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1009, "\p in Button command");
            return 0;
        }
    }
    for (a = b; a < 5; a++) {
...
short cmd_checkbox() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1009, "\p in CheckBox command");
            return 0;
        }
    }
    for (a = b; a < 5; a++) {
...
short cmd_radio() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1009, "\p in Radio command");
            return 0;
        }
    }
    for (a = b; a < 6; a++) {
...
short cmd_timer() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1009, "\p in Timer command");
            return 0;
        }
    }
    for (a = b; a < 3; a++) {
...
short cmd_scrollbar() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1009, "\p in ScrollBar command");
            return 0;
        }
    }
    for (a = b; a < 5; a++) {
...
short cmd_scrollset() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in ScrollSet command");
            return 0;
        }
    }
    for (a = b; a < 4; a++) {
...
short cmd_textbox() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1009, "\p in TextBox command");
            return 0;
        }
    }
    for (a = b; a < 6; a++) {
...
short cmd_list() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in ListBox command");
            return 0;
        }
    }
    for (a = b; a < 6; a++) {
...
short cmd_listadd() {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in ListAdd command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_listclear() {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in ListClear command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_listremove() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in ListRemove command");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
...
short cmd_textboxro() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in TextBoxRO command");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
...
short cmd_label() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in Label command");
            return 0;
        }
    }
    for (a = b; a < 5; a++) {
...
short cmd_pict() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in Picture command");
            return 0;
        }
    }
    for (a = b; a < 6; a++) {
...
short cmd_licon() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in Icon command");
            return 0;
        }
    }
    for (a = b; a < 6; a++) {
...
short cmd_ctlremove() {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlRemove command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_hilite() {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlHilite command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_ctlhide() {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlHide command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_ctlshow() {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlShow command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_ctldisable() {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlDisable command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_ctlenable() {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlEnable command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_ctlsize() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in CtlSize command");
            return 0;
        }
    }
    for (a = b; a < 3; a++) {
...
short cmd_ctlmove() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in CtlMove command");
            return 0;
        }
    }
    for (a = b; a < 3; a++) {
...
short cmd_ctlalign() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in CtlAlign command");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
...
short cmd_ctltext() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in CtlText command");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short cmd_qtopen() {
    ...
    if (c == 2) {
        ...
        v[0] = FindFormID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in WinClose command");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
...
short cmd_textselect() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in TextSelect command");
            return 0;
        }
    }
    for (a = b; a < 3; a++) {
...
short cmd_listselect() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in ListSelect command");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
...
short cmd_listdeselect() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in ListDeselect command");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
...
short cmd_setvalue() {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in SetValue command");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
