...
long grab_varaddress(short varnum) {
    ...
    UCHAR *VIP;
    if (RunVar.VarTable2[varnum].modnum == -1)
        VIP = (UCHAR *) (RunVar.GlobalVarSpace + RunVar.VarTable2[varnum].offset);
...
long grab_intvar(short varnum) {
    ...
    short *VIP;
    if (RunVar.VarTable2[varnum].modnum == -1)
        VIP = (short *) (RunVar.GlobalVarSpace + RunVar.VarTable2[varnum].offset);
...
float grab_singlevar(short varnum) {
    ...
    float *VSP, vv;
    if (RunVar.VarTable2[varnum].modnum == -1)
        VSP = (float *) (RunVar.GlobalVarSpace + RunVar.VarTable2[varnum].offset);
...
short double grab_doublevar(short varnum) {
    ...
    short double *VSD;
    if (RunVar.VarTable2[varnum].modnum == -1)
        VSD = (short double *) (RunVar.GlobalVarSpace + RunVar.VarTable2[varnum].offset);
        ...
        switch (CodeBuf[CodePos]) {
            ...
            case 15:  // String Variable
                ...
                if (RunVar.VarTable2[vx].modnum == -1)  // Global ?
                    ...
                    VR_StrPtr = (UCHAR *) (CallStack[CallStackPtr - PassAssignFlag].varbuf +
                                           RunVar.VarTable2[vx].offset);
