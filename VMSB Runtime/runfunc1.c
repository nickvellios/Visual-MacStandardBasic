...
short func_asc(short rtype) {
    ...
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Asc function");
        return (-1);
    }
    get_stringarg_val();
...
short func_len(short rtype) {
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Len function");
        return (-1);
    }
    get_stringarg_val();
    switch (rtype) {
...
short func_val(short rtype) {
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Val function");
        return (-1);
    }
    get_stringarg_val();
    switch (rtype) {
...
short func_date(short rtype) {
    ...
    ReturnStr[5] = '/';
    ReturnStr[6] = '0' + (now.year / 1000);
    now.year -= (now.year / 1000) * 1000;
    ReturnStr[7] = '0' + (now.year / 100);
    now.year -= (now.year / 100) * 100;
    ReturnStr[8] = '0' + (now.year / 10);
    now.year -= (now.year / 10) * 10;
...
short func_day(short rtype) {
    ...
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Day function");
        return (-1);
    }
    get_stringarg_val();
    if (ReturnStrLen != 10) {
        FreeReturnStr();
        ErrHandler(1050, "\p in Day function");
        return (-1);
    }
    if (!isdigit(ReturnStr[0]) || !isdigit(ReturnStr[1])) {
        FreeReturnStr();
        ErrHandler(1050, "\p in Day function");
        return (-1);
    }
    if (!isdigit(ReturnStr[3]) || !isdigit(ReturnStr[4])) {
        FreeReturnStr();
        ErrHandler(1050, "\p in Day function");
        return (-1);
    }
    for (a = 6; a < 10; a++)
        if (!isdigit(ReturnStr[a])) {
            FreeReturnStr();
            ErrHandler(1050, "\p in Day function");
            return (-1);
        }
    if (ReturnStr[2] != '\/' && ReturnStr[2] != '\\' && ReturnStr[2] != '-') {
        FreeReturnStr();
        ErrHandler(1050, "\p in Day function");
        return (-1);
    }
    if (ReturnStr[5] != '\/' && ReturnStr[5] != '\\' && ReturnStr[2] != '-') {
        FreeReturnStr();
        ErrHandler(1050, "\p in Day function");
        return (-1);
    }
    ...
    year = ((ReturnStr[6] - '0') * 1000) + ((ReturnStr[7] - '0') * 100) + ((ReturnStr[8] - '0') * 10) + ReturnStr[9] -
           '0';
    FreeReturnStr();
    // Allocate ReturnStr Space
    a = Allocate_ReturnStr(16L);
...
short func_typecvt(short rtype) {
    ...
    long tp = 0, ctr = 1, b;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in TypeCvt function");
        return (-1);
    }
    get_stringarg_val();
    for (a = 3; a >= 0; a--) {
...
short func_ucase(short rtype) {
    long a;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Ucase function");
        return (-1);
    }
    get_stringarg_val();
    for (a = 0; a < ReturnStrLen; a++)
...
short func_ltrim(short rtype) {
    long a, b = 0;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Ltrim function");
        return (-1);
    }
    get_stringarg_val();
...
short func_rtrim(short rtype) {
    long a;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Rtrim function");
        return (-1);
    }
    get_stringarg_val();
    if (!ReturnStrLen) return (0);
...
short func_trim(short rtype) {
    long a, b = 0;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Trim function");
        return (-1);
    }
    get_stringarg_val();
    if (!ReturnStrLen) return (0);
    ...
    switch (CodeBuf[CodePos]) {
        case 251:
            ...
            if (CodeBuf[CodePos] == 250 || CodeBuf[CodePos] == 251) {
                ...
                switch (b) {
                    case 0:
                        sprintf(temp, "%13.0f", d);
                        break;
                    case 1:
                        sprintf(temp, "%13.1f", d);
                        break;
                    case 2:
                        sprintf(temp, "%13.2f", d);
                        break;
                    case 3:
                        sprintf(temp, "%13.3f", d);
                        break;
                    case 4:
                        sprintf(temp, "%13.4f", d);
                        break;
                    case 5:
                        sprintf(temp, "%13.5f", d);
                        break;
                    case 6:
                        sprintf(temp, "%13.6f", d);
                        break;
                    case 7:
                        sprintf(temp, "%13.7f", d);
                        break;
                    case 8:
                        sprintf(temp, "%13.8f", d);
                        break;
                    case 9:
                        sprintf(temp, "%13.9f", d);
                        break;
                    case 10:
                        sprintf(temp, "%13.10f", d);
                        break;
                    case 11:
                        sprintf(temp, "%13.11f", d);
                        break;
                    case 12:
                        sprintf(temp, "%13.12f", d);
                        break;
                    case 13:
                        sprintf(temp, "%13.13f", d);
                        break;
                }
            } else {
                // No second param
...
short func_mid(short rtype) {
    ...
    long tReturnStrLen;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Mid function");
        return (-1);
    }
    get_stringarg_val();
    if (!ReturnStrLen) return (0);
...
short func_ctext(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlText function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_fileexist(short rtype) {
    ...
    Str255 fname;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in FileExist function");
        return (-1);
    }
    get_stringarg_val();
...
short func_filesize(short rtype) {
    ...
    Str255 fname;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in FileSize function");
        return (-1);
    }
    get_stringarg_val();
    RStrToStr255(ReturnStr, ReturnStrLen, fname);
...
short func_dir(short rtype) {
    ...
    Str255 fname;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Dir function");
        return (-1);
    }
    get_stringarg_val();
    RStrToStr255(ReturnStr, ReturnStrLen, fname);
...
short func_pictfile(short rtype)  //LoadPict
{
    ...
    Str255 fname;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in PictFile function");
        return (-1);
    }
    get_stringarg_val();
    RStrToStr255(ReturnStr, ReturnStrLen, fname);
...
short func_listcnt(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in ListCnt function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_launch(short rtype) {
    UCHAR app[256];
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in Launch function");
        return (-1);
    }
    get_stringarg_val();
...
short func_gettextlen(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in TextLen function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_gettextstart(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in TextStart function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_gettextend(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in TextEnd function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_gettextselect(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in TextSelect function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_listselcount(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in ListNumSel function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_listselect(short rtype) {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in ListSelect function");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
...
short func_listitem(short rtype) {
    ...
    if (c == 2) {
        ...
        v[0] = FindCtlID(d);
        if (v[0] == -1) {
            ErrHandler(1011, "\p in ListItem function");
            return 0;
        }
    }
    for (a = b; a < 2; a++) {
...
short func_getctlvalue(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlValue function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_fontnum(short rtype) {
    ...
    Str255 fnt, sysfnt;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in FontNum function");
        return (-1);
    }
    get_stringarg_val();
...
short func_opendialog(short rtype) {
    ...
    if (CodeBuf[CodePos] == 249) {
        ...
        ErrHandler(1042, "\p in OpenDialog function");
        return (-1);
    }
...
short func_savedialog(short rtype) {
    ...
    if (CodeBuf[CodePos] == 249) {
        ...
        ErrHandler(1042, "\p in SaveDialog function");
        return (-1);
    }
...
short func_filename(short rtype) {
    long a, b = 0;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in FileName function");
        return (-1);
    }
    get_stringarg_val();
    if (!ReturnStrLen) return (0);
...
short func_winhandle(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindFormID(d);
        if (v == -1) {
            ErrHandler(1009, "\p in WinHandle function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_ctlhandle(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlHandle function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_ctlnum(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindCtlID(d);
        if (v == -1) {
            ErrHandler(1011, "\p in CtlNum function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_winnum(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindFormID(d);
        if (v == -1) {
            ErrHandler(1009, "\p in WinNum function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_wintitle(short rtype) {
    ...
    if (c == 2) {
        ...
        v = FindFormID(d);
        if (v == -1) {
            ErrHandler(1009, "\p in WinTitle function");
            return 0;
        }
    } else {
        switch (CodeBuf[CodePos++]) {
...
short func_numfiles(short rtype) {
    long a = 0, b = 0;
    if (CodeBuf[CodePos++] != 249) {
        ErrHandler(1042, "\p in NumOfFiles function");
        return (-1);
    }
    get_stringarg_val();
        ...
        for (a = startp; a < ReturnStrLen; a++) {
            if (v[1]) {  // case sensitive
                ...
                if (toupper(ReturnStr[a]) == ch) // first char match
                {
                    ...
                    b = 0;
                    while (b < st1_len && g < ReturnStrLen)
                        if (toupper(ReturnStr[g++]) != toupper(st1[b++])) {
                            flag = 1;
                            break;
                        }
                }
